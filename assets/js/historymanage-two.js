...
function changeVersion (liTag) {
    ...
    if (curUrl.indexOf("web-twain/docs-archive/v17.3/") > 0 && GetVersionDiff('17.2.1', ver) < 0) {
        verFileName = '/v17.2.1/';
    } 
    console.log(verFileName)
	...
	if (curUrl.indexOf("web-twain/docs-archive/v17.3/") > 0 && ver == "latest") {
        curUrl = curUrl.replace("/docs-archive/v17.3/", "/docs/")
        // console.log(curUrl)
        window.location.href = curUrl
        return
    } else {
        curUrl = curUrl.replace("/docs-archive/v17.3/", "/docs-archive" + verFileName)
        // console.log(curUrl)
        window.location.href = curUrl;
	    return;
    }
