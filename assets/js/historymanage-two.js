...
function changeVersion (liTag) {
    ...
    if (curUrl.indexOf("web-twain/docs-archive/v18.4/") > 0 && GetVersionDiff('17.2.1', ver) < 0) {
        verFileName = '/v17.2.1/';
    }
	...
	if (curUrl.indexOf("web-twain/docs-archive/v18.4/") > 0 && ver == "latest") {
        curUrl = curUrl.replace("/docs-archive/v18.4/", "/docs/")
        window.location.href = curUrl
        return
    } else {
        curUrl = curUrl.replace("/docs-archive/v18.4/", "/docs-archive" + verFileName)
        window.location.href = curUrl;
	    return;
    }
}
