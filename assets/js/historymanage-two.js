...
function changeVersion (liTag) {
    ...
    if (curUrl.indexOf("web-twain/docs-archive/v18.3/") > 0 && GetVersionDiff('17.2.1', ver) < 0) {
        verFileName = '/v17.2.1/';
    }
	...
	if (curUrl.indexOf("web-twain/docs-archive/v18.3/") > 0 && ver == "latest") {
        curUrl = curUrl.replace("/docs-archive/v18.3/", "/docs/")
